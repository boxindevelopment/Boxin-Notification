...
class OrderDetail extends Model
{
    ...
    public function box()
    {
        return $this->belongsTo('App\Models\Box', 'room_or_box_id', 'id');
    }

    public function room()
    {
        return $this->belongsTo('App\Models\Room', 'room_or_box_id', 'id');
    }

    public function space_small()
    {
        return $this->belongsTo('App\Models\SpaceSmall', 'room_or_box_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Models\OrderDetailBox', 'order_detail_id', 'id');
    }

    public function return_box()
    {
        return $this->hasMany('App\Models\ReturnBoxes', 'order_detail_id', 'id');
    }

    public function return_box_payment()
    {
        return $this->hasMany('App\Models\ReturnBoxPayment', 'order_detail_id', 'id');
    }

    public function change_box_payment()
    {
        return $this->hasMany('App\Models\ChangeBoxPayment', 'order_detail_id', 'id');
    }

    public function change_box()
    {
        return $this->hasMany('App\Models\ChangeBox', 'order_detail_id', 'id');
    }
